...
namespace UsuariosAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<Repositorio<Usuario, string>>(sp => new RepositorioMongoDB<Usuario, string>("usuarios"));
            ...
            //services.AddSingleton<ICodigoActivacionRepository>(sp =>new CodigoActivacionRepository("codigos"));
